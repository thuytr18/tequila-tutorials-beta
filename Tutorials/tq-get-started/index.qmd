...
The following image showcases the creation some abstract quantum functions with tequila.
As you can see, the underlying functionalities are implemented at a very high-level manner, such that the required inputs for function calls are more of less strightforward mathematical expressions.
